...
def loan_info_view(request):
    ...
    try:
        id_front = normalize_upload_image(id_front_raw, max_side=500, quality=75, out_format="WEBP")
        id_back = normalize_upload_image(id_back_raw, max_side=500, quality=75, out_format="WEBP")
        selfie_with_id = normalize_upload_image(selfie_raw, max_side=500, quality=75, out_format="WEBP")
    except ValueError as e:
        return _err(str(e))
    except Exception:
